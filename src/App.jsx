...
export default function App() {
  return (
    <div>
      <NavBar />
      <div id = "sbd" className="min-h-screen bg-customBlack text-white flex flex-col justify-center items-center py-8">
        <div className="flex flex-col md:flex-row items-center max-w-6xl mx-auto">
          <img src={SBDLogo} alt="SBD logo" className="h-64 w-64" />
          <div className="md:ml-4">
            <h1 className="text-2xl md:text-4xl font-bold text-white text-left">NETLAB SBD</h1>
